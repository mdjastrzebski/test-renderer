...
/**
 * Host config methods called while the tree is being built up, before it is connected to the
 * tree "on the screen": instance creation, host context and public instances.
 */
export const renderPhaseHostConfig = {
  /**
